...
Spätestens mit der Nutzung der neuen \emph{Mehrkernprozessoren} ist die Grenze der durch menschliche Entwickler sicher beherrschbare Komplexität überschritten.
...
Die hohe Bedeutung der Ergebnisse für die Industrie in der Luft"= und Raumfahrt wird unter anderem auch durch den derzeitigen Einsatz des Werkzeugs bei einem großen Hersteller ziviler Verkehrsflugzeuge unterstrichen.
Mit Hilfe des Werkzeugs sind hier erstmals tiefgreifende Optimierungen in der Architektur existierender Steuersysteme zugänglich, die bisher aufgrund ihrer Komplexität und einer daraus resultierenden Unsicherheit bezüglich ihrer Realisierbarkeit vermieden wurden.
...
Sprunghafte technologische Weiterentwicklungen als Folge eines individuellen "`Geistesblitzes"' oder "`Out"=Of"=The"=Box"=Thinking"' sind mit einem derartigen Vorgehen allerdings deutlich unwahrscheinlicher.

Als Konsequenz einer zunehmenden Verwendung von standardisierten "`Konstruktionsalgorithmen"' sind die Auswirkungen von unentdeckten Fehlern in diesen Algorithmen wesentlich brisanter, denn sie betreffen eine wesentlich größere Gruppe Systemen.
Während die Ingenieurwissenschaften bereits heute bei der Entwicklung von (Einzel-) Systemen an den Grenzen der beherrschbaren Komplexität agieren, muss kritisch hinterfragt werden, ob die Entwicklung von derartigen "`Konstruktionsalgorithmen"' für eine ganze Klasse an Systemen mit der erforderlichen Fehlerfreiheit zu leisten ist. 
...
Die Ergebnisse dieser Arbeit -- und insbesondere das Werkzeug ASSIST -- bieten sich dazu als konkreter Untersuchungsgegenstand an.
