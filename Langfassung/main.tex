...
\begin{figure}[h!tbp]
  ...
  \caption{Steuerflächen eines Flugleitsystems in einem Verkehrsflugzeug\newline{}\footnotesize Quelle: Liebherr Aerospace - mit freundlicher Genehmigung}
  \label{fig:fcs}
\end{figure}
...
Dies bricht mit der traditionellen Arbeitsteilung zwischen Mensch und Maschine bei der Entwicklung.
...
Mit Hilfe von speziellen Isolationstechniken können diese Ressourcen auch gemeinsam von verschiedenen Softwarekomponenten genutzt werden.
...
Dieses Verfahren wird als Softwarewerkzeug umgesetzt und anhand von zwei Fallbeispielen aus der Luft- und Raumfahrt erprobt.
...
Durch den Einsatz des Softwarewerkzeugs konnte die benötigte Zeitdauer für die Konstruktion \emph{einer} vollständigen und fehlerfreien Zuweisung von ehemals ca. 12-15~Monaten auf den Zeitraum von etwa 5~Minuten reduziert werden.
Auf dieser Grundlage konnten erstmals unterschiedliche Zuweisungen konstruiert und miteinander verglichen werden, so dass letztendlich auch Geräte eingespart und Materialkosten gesenkt werden konnten.
...
Was passiert mit der "`technischen Kompetenz"' unserer Gesellschaft, wenn die Entwicklung der zentralen Steuersysteme unserer zukünftigen Fahrzeuge in immer kürzerer Zeit durch Computer durchgeführt wird?
...
Ist es dann weiterhin wünschenswert, dass diese Systeme in zunehmendem Maße die Verantwortung für unsere Sicherheit übernehmen? 
...
Selbst bei einem kleinen System mit nur 10 Prozessoren und lediglich 25 Softwarekomponenten gibt es theoretisch bereits $10^{25}$ Platzierungsmöglichkeiten für die Softwarekomponenten.
